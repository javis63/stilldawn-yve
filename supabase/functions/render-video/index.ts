...
// ============================================================================
// VPS RENDER PIPELINE
// Calls your local VPS with FFmpeg instead of Replicate's cog-ffmpeg
// This allows rendering long videos without file size limits
// ============================================================================
...
async function generateSeoMetadata(projectTitle: string, narrations: string[]): Promise<{
  title: string;
  description: string;
  keywords: string;
  hashtags: string;
...
async function processRender(
  ...
  try {
    ...
    await updateProgress(`Sending ${vpsScenes.length} scenes to VPS for rendering...`);
